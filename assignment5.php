...
<body background="abc.jpg">
	...
	<h1 class="headings">National Workshop on Web Technology</h1>
	<div class="formdiv" >
		<form  method="post">
			<table cellpadding="15px">
				...
				<tr>
					...
					<td>
  						<input type="radio" id="Student" name="type" value="Faculty">
						<label for="Faculty">Faculty</label><br>
						<input type="radio" id="Faculty" name="type" value="Student">
